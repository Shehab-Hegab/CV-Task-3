...
#         # self.ui.match_button.clicked.connect(self.computeKeypointsAndDescriptors)
...
#             self.ui.original_image.setPixmap(pixmap.scaled(281, 221, QtCore.Qt.KeepAspectRatio))
#         self.computeKeypointsAndDescriptors(image1)
...
#         if file_path:
#             pixmap = QtGui.QPixmap(file_path)
#             self.ui.scaled_image.setPixmap(pixmap.scaled(281, 221, QtCore.Qt.KeepAspectRatio))
#         self.computeKeypointsAndDescriptors(image2)
