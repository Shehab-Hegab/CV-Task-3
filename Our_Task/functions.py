...
class SIFTProcessor(QMainWindow):
    def __init__(self):
        ...
        self.ui.match_button.clicked.connect(self.start_match)
    ...
    def start_match(self):
        ...
        kp1, des1 = self.computeKeypointsAndDescriptors(image1)
        kp2, des2 = self.computeKeypointsAndDescriptors(image2)
